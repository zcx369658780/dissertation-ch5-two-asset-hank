# CH5_TWO_ASSET_HANK_R4_STEADY_STATE_IMPLEMENTATION_RERUN_AFTER_LATEST_SLACK_LOWER_B_08125

## Task

Re-run the R4 frozen steady-state implementation after accepted latest upper-a/lower-b slack lower-b forward closure resolution at `(a,b,z)=(1.0,0.0,0.8125)`.
...
- Upper-a/interior-b closure accepted.
- Latest upper-a/lower-b slack lower-b forward closure accepted.
