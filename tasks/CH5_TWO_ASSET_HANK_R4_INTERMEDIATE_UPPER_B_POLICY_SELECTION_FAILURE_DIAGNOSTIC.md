# CH5_TWO_ASSET_HANK_R4_INTERMEDIATE_UPPER_B_POLICY_SELECTION_FAILURE_DIAGNOSTIC

## Task

Diagnose the next frozen R4 steady-state primary HJB policy-selection failure after accepted zero-liquid certification, interior-a zero-drift construction, upper-a boundary contract resolution, and dual upper-corner boundary closure resolution.

## Authority

This task is the sole execution authority for bounded R4 intermediate upper-b policy-selection diagnostic work.
...
- Frozen R4 rerun failed at `(a,b,z)=(0.5,5.0,1.0)`.
...
- inspect upper-b boundary interactions;
- inspect upper-a/upper-b contract interaction;
...
- upper-b boundary consistency;
- interaction with existing upper-a and dual corner contracts;
- KKT consistency;
