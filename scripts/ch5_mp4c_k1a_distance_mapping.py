...
def normalize_lf_bytes(path: Path) -> None:
    """Keep generated-manifest source bytes identical to Git's text blob."""
...
- Worktree: `{worktree}`.
- Branch: `codex/ch5-k1a-distance-mapping-20260911-v2`.
...
def main() -> None:
    ...
    script_path = repo / "scripts" / "ch5_mp4c_k1a_distance_mapping.py"
    normalize_lf_bytes(script_path)
    manifest_targets = [
        script_path,
        report_path,
