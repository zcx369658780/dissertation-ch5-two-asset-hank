# CH5_TWO_ASSET_HANK_R4_STEADY_STATE_IMPLEMENTATION_RERUN_AFTER_DUAL_UPPER_CORNER

## Task

Re-run the R4 frozen steady-state implementation after accepted dual upper-corner boundary closure resolution.
