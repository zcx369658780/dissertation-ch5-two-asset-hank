# CH5_TWO_ASSET_HANK_R4_STEADY_STATE_IMPLEMENTATION_RERUN_AFTER_UPPER_A_LOWER_B

## Task

Re-run the R4 frozen steady-state implementation after accepted upper-a/lower-b joint zero-drift closure resolution.
