"""Finalize saved corrected-2018 three-turn evidence without model calls."""
...
PASS = "CORRECTED_2018_THREE_TURN_PASS__DIRECT_CORRECTED_RATE_PROPAGATION_OBSERVED"
...
def finalize() -> None:
    ...
    copies = {
        "runtime_input_receipt.json", "turn1_reproduction.json", "turn2_reproduction.json",
...
"""
    ...
    write_json(REPORT_DIR / "manifest.json", {
        "schema": "CH5_CORRECTED_2018_THREE_TURN_REPO_MANIFEST_V1", "files": repo_records})
    ...
    write_json(EVIDENCE / "manifest.json", {
        "schema": "CH5_CORRECTED_2018_THREE_TURN_EVIDENCE_MANIFEST_V1", "files": external_records})
