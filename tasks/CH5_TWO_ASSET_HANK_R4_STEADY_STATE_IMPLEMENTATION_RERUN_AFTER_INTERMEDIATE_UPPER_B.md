# CH5_TWO_ASSET_HANK_R4_STEADY_STATE_IMPLEMENTATION_RERUN_AFTER_INTERMEDIATE_UPPER_B

## Task

Re-run the R4 frozen steady-state implementation after accepted intermediate upper-b policy fixture resolution.
