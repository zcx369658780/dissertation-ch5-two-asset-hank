...
def main():
    ...
    parser.add_argument('kind',choices=['trajectory','replay'])
    ...
    limit=500 if args.kind=='trajectory' else 1
    timeout=2700 if args.kind=='trajectory' else 900
    ...
    expected_init='1718984CB588AE586F74AB8476C57AF849BB2C80CC95500329D29BC14207BB81' if args.kind=='trajectory' else json.loads((ROOT/'replay_state_identity.json').read_text())['sha256']
